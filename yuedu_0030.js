...
class Yuedu0030 extends ComicSource {
    name = "\u5947\u6f2b\u5c4b\u5b50\uff08\u4f18\uff09"
    key = "yuedu_0030"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0030.js"

    baseUrl = "https://m.qimanwu.app"
    searchUrl = "https://m.qimanwu.app"
    ...
    contentSelector = "{'content': 'img, img src\\n js:\\nresult.split(\"\\\\n\").map(url => ` <img src=\"${url}\"> `).join(\"\\\\n\")', 'imageStyle': 'FULL'}"
