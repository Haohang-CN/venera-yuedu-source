...
class Yuedu0157 extends ComicSource {
    name = "\ud83c\udfa8 \u54aa\u5495\u52a8\u6f2b"
    key = "yuedu_0157"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0157.js"

    baseUrl = "http://m.migudm.cn\u5df2\u6574\u7406"
    searchUrl = "http://m.migudm.cn\u5df2\u6574\u7406"
    ...
    contentSelector = "{'content': '$.data.watchUrlListWebp.[*]url\\n js:\\nlist=result.split(\"\\\\n\");\\nhtml=\\'\\';\\nfor(i in list){\\nhtml+=\\'<img src=\"\\'+list[i]+\\'\">\\\\n\\'\\n}\\nhtml', 'imageStyle': 'FULL'}"
    contentAttr = "text"
