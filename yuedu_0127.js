...
class Yuedu0127 extends ComicSource {
    name = "\u5305\u5b50\u6f2b\u753b"
    key = "yuedu_0127"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0127.js"

    baseUrl = "https://cn.webmota.com"
    searchUrl = "https://cn.webmota.com"
    ...
    contentSelector = "{'content': 'amp-img img src js:headers={\"headers\":{\"Referer\":baseUrl}};\\nresult.split(\"\\\\n\").map(x=>\\'<img src=\\\\\"\\'+x+\\',\\'+JSON.stringify(headers)+\\'\\\\\">\\').join(\"\\\\n\")', 'imageStyle': 'FULL', 'nextContentUrl': ' css:a:contains(\u4e0b\u4e00\u9875) href', 'webJs': ''}"
    contentAttr = "text"
