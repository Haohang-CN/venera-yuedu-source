...
class Yuedu0212 extends ComicSource {
    name = "\u5999\u534e\u53f0\u85cf"
    key = "yuedu_0212"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0212.js"

    baseUrl = "https://m.manhuatai.com/"
    searchUrl = "https://m.manhuatai.com/"
    ...
    contentSelector = "{'content': '$..current_chapter.chapter_img_list.[*] js:headers={\"headers\":{\"Referer\":baseUrl}};\\nresult.split(\"\\\\n\").map(x=>\\'<img src=\\\\\"\\'+x+\\',\\'+JSON.stringify(headers)+\\'\\\\\">\\').join(\"\\\\n\")', 'imageStyle': 'FULL'}"
    contentAttr = "text"
