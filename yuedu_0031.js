...
class Yuedu0031 extends ComicSource {
    name = "\u91ce\u86ee\u6f2b\u753b\uff08\u4f18\uff09"
    key = "yuedu_0031"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0031.js"

    baseUrl = "https://mhbao.colacomic.com"
    searchUrl = "https://mhbao.colacomic.com"
    ...
    contentSelector = "{'content': '#imgsec img data-src js:\\nheaders={\"headers\":{\"Referer\":baseUrl}}\\n;\\nresult.split(\"\\\\n\").map(x=>\\'<img src=\\\\\"\\'+x+\\',\\'+JSON.stringify(headers)+\\'\\\\\">\\').join(\"\\\\n\")', 'imageStyle': 'FULL', 'nextContentUrl': ' css:a[href~=(-, _)\\\\d+]:contains(\u4e0b\u4e00\u9875) href'}"
    contentAttr = "text"
