...
class Yuedu0100 extends ComicSource {
    name = "\u767e\u5e74\u6f2b\u753b"
    key = "yuedu_0100"
    version = "1.0.2"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0100.js"

    baseUrl = "https://m.bnman.net"
    searchUrl = "https://m.bnman.net"
    ...
    contentSelector = "{'content': '<js>\\ndata=result.match(/z_img=\\'([^\\']*)/)[1];\\n</js>\\n$.[*] js:\\nhost=\"https://img.hngxgt.net/\";\\nif(result.match(/^zhang, ^upload/)){result.split(\"\\\\n\").map(x=>\\'<img src=\\\\\"\\'+host+x+\\'\\\\\">\\').join(\"\\\\n\")};\\nif(result.match(/http/))\\n{result.split(\"\\\\n\").map(x=>\\'<img src=\\\\\"\\'+x+\\'\\\\\">\\').join(\"\\\\n\")};', 'imageStyle': 'FULL', 'nextContentUrl': '', 'replaceRegex': '', 'sourceRegex': '', 'webJs': ''}"
    contentAttr = "text"
