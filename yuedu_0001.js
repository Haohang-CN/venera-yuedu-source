...
class Yuedu0001 extends ComicSource {
    name = "\u56fe\u5e93\u6f2b\u753b"
    key = "yuedu_0001"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0001.js"

    baseUrl = "https://www.tuku.cc/"
    searchUrl = "https://www.tuku.cc/"
    ...
    contentSelector = "{'content': 'class.content img data-original\\n js:\\nresult = result.split(\"\\\\n\");\\nvar list = \\'\\';\\nfor (var i = 0; i < result.length; i++) {\\n    if (result[i] != \\'\\'){\\n        list += \"<img src=\\'\" + result[i] + \"\\'>\";\\n    }\\n}\\nlist;'}"
    contentAttr = "text"
