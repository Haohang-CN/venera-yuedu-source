class YDOK0103 extends ComicSource {
    name = "\u591a\u591a\u6f2b\u753b\ud83c\udd70"
    key = "ydok_0103"
    version = "2.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/ydok_0103.js"

    baseUrl = "https://api.duoduomh.1a3.net"
    searchUrl = "https://api.duoduomh.1a3.net"
    ...
    contentSelector = "{'content': '$.data.imageArray\\n js:\\nlist=result.split(\"\\\\n\");\\nhtml=\\'\\';\\nfor(i in list){\\nhtml+=\\'<img src=\"\\'+list[i]+\\'\">\\\\n\\'\\n}\\nhtml', 'imageStyle': 'FULL'}"
    contentAttr = "text"
