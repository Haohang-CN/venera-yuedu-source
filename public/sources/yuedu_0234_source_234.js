class YueduConvertedSource extends ComicSource {
    name = "快看漫画"
    key = "yuedu_0234_source_234"
    version = "1.0.0"
    minAppVersion = "1.0.0"
    url = "http://m.kuaikanmanhua.com#未月十八发现"

    // 原始阅读书源规则，保留在这里，方便后续手工改写
    rawYueduSource = {
  "bookSourceComment": "Error: org.mozilla.javascript.WrappedException: Wrapped java.lang.ArrayIndexOutOfBoundsException: length=13; index=20 (<Unknown source>#1) in <Unknown source> at line number 1\n未月十八发现",
  "bookSourceGroup": "漫画",
  "bookSourceName": "快看漫画",
  "bookSourceType": 0,
