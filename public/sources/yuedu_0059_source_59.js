class YueduConvertedSource extends ComicSource {
    name = "✾.快看漫画 已"
    key = "yuedu_0059_source_59"
    version = "1.0.0"
    minAppVersion = "1.0.0"
    url = "http://m.kuaikanmanhua.com已发现wy-"

    // 原始阅读书源规则，保留在这里，方便后续手工改写
    rawYueduSource = {
  "bookSourceComment": "已发现",
  "bookSourceGroup": "漫画",
  "bookSourceName": "✾.快看漫画 已",
  "bookSourceType": 0,
  "bookSourceUrl": "http://m.kuaikanmanhua.com已发现wy-",
  "bookUrlPattern": "",
  "customOrder": 1333,
  "enabled": true,
