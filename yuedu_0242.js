...
class Yuedu0242 extends ComicSource {
    name = "\u661f\u706b\u6f2b\u753b\uff08\u4f18\uff09"
    key = "yuedu_0242"
    version = "1.0.2"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0242.js"

    baseUrl = "http://www.vomicmh.com"
    searchUrl = "http://www.vomicmh.com"
    ...
    contentSelector = "{'content': '#app > div > div.scroll-wrapper.page-scroll > div html\\n js:\\nvar html=result;\\nvar result = html.replace(/<img[^>]*\\\\bsrc=\"(https?:\\\\/\\\\/[^\"]+\\\\.jpg)\"[^>]*>/g, \\'<img src=\"$1\">\\');\\nresult;', 'replaceRegex': '"
    contentAttr = "text"
