...
class Yuedu0095 extends ComicSource {
    name = "\u6b66\u828a\u6f2b\u753b\uff08\u4f18+\uff09"
    key = "yuedu_0095"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0095.js"

    baseUrl = "https://comic.mkzcdn.com"
    searchUrl = "https://comic.mkzcdn.com"
    ...
    contentSelector = "{'content': '$.data[*].image\\n js:\\nresult.split(\"\\\\n\").map(x=>\\'<img src=\"\\'+x+\\'\">\\').join(\"\\\\n\")'}"
    contentAttr = "text"
