...
class Yuedu0225 extends ComicSource {
    name = "\u54aa\u5495\u52a8\u6f2b$"
    key = "yuedu_0225"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0225.js"

    baseUrl = "http://m.migudm.cn#"
    searchUrl = "http://m.migudm.cn#"
    ...
    contentSelector = "{'content': '$.data.jpgList.[*]url\\n js:\\nlist=result.split(\"\\\\n\");\\nhtml=\\'\\';\\nfor(i in list){\\nhtml+=\\'<img src=\"\\'+list[i]+\\'\">\\\\n\\'\\n}\\nhtml', 'imageStyle': 'FULL'}"
    contentAttr = "text"
