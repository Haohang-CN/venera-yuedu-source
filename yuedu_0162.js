...
class Yuedu0162 extends ComicSource {
    name = "\u65b0\u4eba\u6f2b\u753b"
    key = "yuedu_0162"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0162.js"

    baseUrl = "https://xapi.xinmanhua.net#Haxc1107"
    searchUrl = "https://xapi.xinmanhua.net#Haxc1107"
    ...
    contentSelector = "{'content': '$.data[*].attributes.url\\n js:list=result.split(\\'\\\\n\\');\\nlist.map(x=>\\'<img src=\"\\'+x+\\'\">\\').join(\\'\\\\n\\')', 'imageStyle': 'FULL', 'webJs': ''}"
    contentAttr = "text"
