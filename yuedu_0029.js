...
class Yuedu0029 extends ComicSource {
    name = "\u88e4\u88e4\u6f2b\u753b\uff08\u4f18\uff09"
    key = "yuedu_0029"
    version = "1.0.2"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0029.js"

    baseUrl = "http://www.kukuc.net"
    searchUrl = "http://www.kukuc.net"
    ...
    contentSelector = "{'content': '#content p a img src\\n js:\\nresult.split(\\'\\\\n\\').map(x => \\'<img src=\"\\'+x+\\',{\"headers\":{\"Referer\":\"\\'+x+\\'\"}}\">\\').join(\\'\\\\n\\')'}"
    contentAttr = "text"
