...
class Yuedu0104 extends ComicSource {
    name = "UAA\u6f2b\u753b"
    key = "yuedu_0104"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0104.js"

    baseUrl = "https://www.uaa.com/app"
    searchUrl = "https://www.uaa.com/app"
    ...
    contentSelector = "{'content': '$.model.images[*]\\n js:\\nlist=result.split(\"\\\\n\");\\nhtml=\\'\\';\\nfor(i in list){\\nhtml+=\\'<img src=\"\\'+list[i]+\\'\">\\';\\n}\\nhtml\\n', 'imageStyle': 'FULL'}"
    contentAttr = "text"
