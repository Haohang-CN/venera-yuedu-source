...
class Yuedu0120 extends ComicSource {
    name = "\u5305\u5b50\u6f2b\u753b"
    key = "yuedu_0120"
    version = "1.0.0"
    minAppVersion = "1.6.0"
    url = "https://raw.githubusercontent.com/Haohang-CN/venera-yuedu-source/main/yuedu_0120.js"

    baseUrl = "https://cn.baozimh.org/"
    searchUrl = "https://cn.baozimh.org/"
    ...
    contentSelector = "{'content': 'class.w-full h-full img src js:result.split(\"\\\\n\").map(x=>\\'<img src=\"\\'+x+\\'\">\\').join(\"\\\\n\")', 'imageStyle': 'FULL', 'nextContentUrl': '', 'title': ''}"
    contentAttr = "text"
